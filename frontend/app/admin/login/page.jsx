    ...
    <main className="min-h-screen px-4 py-12 text-stone-100 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-lg rounded-[2rem] border border-white/10 bg-[var(--panel)]/90 p-8 shadow-[0_20px_70px_rgba(0,0,0,0.4)]">
        <div className="text-center">
          ...
          <p className="mt-4 text-[10px] uppercase tracking-[0.45em] text-[var(--gold)]">Acceso privado</p>
          <h1 className="mt-3 font-[family-name:var(--font-display)] text-4xl font-light text-white">Panel de administración</h1>
          <p className="mt-3 text-sm leading-7 text-stone-400">Ingresa para ver métricas reales, pedidos y contactos.</p>
        </div>

        <form onSubmit={submit} className="mt-8 space-y-4">
          <label className="block">
            <span className="mb-2 block text-[10px] uppercase tracking-[0.35em] text-[var(--gold)]">Contraseña</span>
          ...
          <div className="text-center text-xs text-stone-500">
            <Link href="/" className="transition hover:text-[var(--gold)]">Volver a la landing</Link>
          </div>
        </form>
      </div>
    </main>
